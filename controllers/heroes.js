const heroes = [
   ...
   },
   {
      ...
      spells: [
         ...
         "Counterspell",
         "Mana Void",
         { shard: "Counterspell Ally", scepter: "Blink Fragment" },
      ],
   },
   {
      name: "arc_warden",
   ...
   },
   {
      ...
      spells: [
         ...
         "Death Pact",
         "Skeleton Walk",
         { shard: "Burning Barrage", scepter: "Burning Army" },
      ],
   },
   {
      name: "clockwerk",
      ...
      spells: [
         ...
         "Rocket Flare",
         "Hookshot",
         { shard: "Jetpack", scepter: "Overclocking" },
      ],
   },
   {
      name: "crystal_maiden",
   ...
   },
   {
      ...
      type: "Strength",
      mainInfo:
         "CAN PREVENT SINGLE OR MULTIPLE ENEMIES FROM USING ABILTIES AND ITEMS",
      attackType: "Melee",
      complexity: 2,
   ...
   },
   {
      ...
      spells: [
         ...
         "Nature's Attendants",
         "Untouchable",
         { shard: "Sproink", scepter: "Little Friends" },
      ],
   },
   {
      name: "enigma",
   ...
   },
   {
      ...
      spells: [
         ...
         "Scurry",
         "Sharpshooter",
         { shard: "Hunter's Boomerang", scepter: "Decoy" },
      ],
   },
   {
      name: "huskar",
   ...
   },
   {
      ...
      spells: [
         ...
         "Solar Bind",
         "Spirit Form",
         { shard: "Recall", scepter: "Will-O-Wisp" },
      ],
   },
   {
      name: "kunkka",
      ...
      spells: [
         ...
         "X Marks the Spot",
         "Ghostship",
         { shard: "Tidal Wave", scepter: "Torrent Storm" },
      ],
   },
   {
   ...
   },
   {
      ...
      spells: [
         ...
         "Dumb Luck",
         "Multicast",
         { shard: "Fire Shield", scepter: "Unrefined Fireblast" },
      ],
   },
   {
      name: "omniknight",
   ...
   },
   {
      ...
      spells: [
         ...
         "Metamorphosis",
         "Sunder",
         { shard: "Demon Zeal", scepter: "Terror Wave" },
      ],
   },
   {
      name: "tidehunter",
   ...
   },
   {
      ...
      spells: [
         ...
         "Plague Ward",
         "Noxious Plague",
         { shard: "Latent Toxicity", scepter: "Poison Nova" },
      ],
   },
   {
      name: "viper",
   ...
   },
   {
      ...
      spells: [
         ...
         "Heavenly Jump",
         "Thundergod's Wrath",
         { shard: "Lighting Hands", scepter: "Nimbus" },
      ],
   },
];
